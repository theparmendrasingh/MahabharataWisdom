...
class SettingsScreen extends StatelessWidget {
      ...
      body: ListView(
        children: [
          ...
          _buildActionTile(
            ...
            title: lang == 'en' ? 'Disclaimer' : 'अस्वीकरण',
            subtitle:
                lang == 'en' ? 'Important information' : 'महत्वपूर्ण जानकारी',
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color:
                  isDark ? Colors.orange.shade200 : Colors.deepOrange.shade800,
            ),
          ),
        ],
      ),
  ...
  Widget _buildFontSizeSelector(
      BuildContext context, AppSettings settings, String lang, bool isDark) {
    return Card(
  ...
  Widget _buildFontSizeOption(AppSettings settings, FontSize size, String label,
      String sample, double sampleSize, bool isDark) {
